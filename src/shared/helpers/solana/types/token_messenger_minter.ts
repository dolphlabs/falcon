        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: "const";
                value: [108, 111, 99, 97, 108, 95, 116, 111, 107, 101, 110];
              },
              {
                kind: "account";
                path: "localTokenMint";
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: "const";
                value: [116, 111, 107, 101, 110, 95, 112, 97, 105, 114];
              },
              {
                kind: "arg";
  ...
  accounts: [
    {
      ...
      discriminator: [186, 58, 212, 239, 102, 131, 157, 146];
    },
    {
      name: "localToken";
      discriminator: [159, 131, 58, 170, 193, 84, 128, 182];
    },
    {
      name: "messageTransmitter";
    ...
    {
      name: "tokenMessenger";
      discriminator: [162, 4, 242, 52, 147, 243, 221, 96];
    },
    {
      name: "tokenMinter";
      discriminator: [122, 133, 84, 63, 57, 159, 171, 206];
    },
    {
      name: "tokenPair";
      discriminator: [17, 214, 45, 176, 229, 149, 197, 71];
    }
  ];
  events: [
    {
      name: "denylisted";
      discriminator: [20, 145, 173, 200, 182, 17, 234, 154];
    },
    {
      name: "denylisterChanged";
      discriminator: [249, 170, 81, 180, 185, 175, 138, 72];
    },
    {
      name: "depositForBurn";
      discriminator: [144, 252, 145, 146, 6, 74, 167, 235];
    },
    {
      name: "feeRecipientSet";
      discriminator: [99, 140, 80, 35, 245, 176, 179, 110];
    },
    {
      name: "localTokenAdded";
      discriminator: [146, 8, 224, 150, 122, 173, 23, 39];
    },
    {
      name: "localTokenRemoved";
      discriminator: [181, 204, 1, 95, 2, 50, 66, 210];
    },
    {
      name: "minFeeControllerSet";
      discriminator: [239, 12, 122, 105, 231, 114, 13, 196];
    },
    {
      name: "minFeeSet";
      discriminator: [60, 127, 101, 230, 216, 129, 188, 98];
    },
    {
      name: "mintAndWithdraw";
      discriminator: [75, 67, 229, 70, 162, 126, 0, 71];
    },
    {
    ...
    },
    {
      ...
      discriminator: [251, 29, 63, 244, 48, 114, 210, 175];
    },
    {
      name: "remoteTokenMessengerRemoved";
      discriminator: [255, 121, 137, 39, 230, 125, 11, 30];
    },
    {
      name: "setBurnLimitPerMessage";
      discriminator: [98, 152, 88, 191, 245, 30, 27, 209];
    },
    {
      name: "setTokenController";
      discriminator: [193, 44, 243, 83, 230, 72, 120, 216];
    },
    {
      name: "tokenCustodyBurned";
      discriminator: [219, 143, 107, 226, 67, 75, 178, 46];
    },
    {
      name: "tokenPairLinked";
      discriminator: [2, 14, 177, 64, 155, 93, 196, 141];
    },
    {
      name: "tokenPairUnlinked";
      discriminator: [78, 232, 230, 208, 180, 212, 246, 72];
    },
    {
      name: "unDenylisted";
      discriminator: [150, 39, 227, 20, 162, 180, 5, 242];
    },
    {
      name: "unpause";
